    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(verifyCode.equals(code)){
                ...
                dao.updateStatusAccount(email);
            } else {
                request.setAttribute("ERRORCODE", "verify code is not matched!");
            }
        } catch(SQLException e) {
            log("SQLException_VerifyCodeServlet: " + e.getMessage());
        } catch(NamingException e) {
            log("NamingException_VerifyCodeServlet: " + e.getMessage());
        } 
        finally {
